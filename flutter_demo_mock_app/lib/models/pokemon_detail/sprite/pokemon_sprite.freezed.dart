...
class _$PokemonSpriteImpl implements _PokemonSprite {
  const _$PokemonSpriteImpl(
      ...
      @JsonKey(name: 'back_shiny') this.backShiny = null,
      @JsonKey(name: 'back_shiny_female') this.backShinyFemale = null,
  ...
  @override
  String toString() {
    return 'PokemonSprite(backDefault: $backDefault, backFemale: $backFemale, backShiny: $backShiny, backShinyFemale: $backShinyFemale, frontDefault: $frontDefault, frontFemale: $frontFemale, frontShiny: $frontShiny, frontShinyFemale: $frontShinyFemale)';
  }
