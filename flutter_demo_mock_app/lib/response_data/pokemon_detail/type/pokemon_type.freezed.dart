...
abstract class $PokemonTypeCopyWith<$Res> {
  ...
  @useResult
  $Res call({int slot, PokemonTypeDetail type});

  $PokemonTypeDetailCopyWith<$Res> get type;
}
...
class _$PokemonTypeCopyWithImpl<$Res, $Val extends PokemonType>
  ...
  @pragma('vm:prefer-inline')
  $PokemonTypeDetailCopyWith<$Res> get type {
    return $PokemonTypeDetailCopyWith<$Res>(_value.type, (value) {
...
abstract class _PokemonType implements PokemonType {
  const factory _PokemonType(
      ...
      required final PokemonTypeDetail type}) = _$PokemonTypeImpl;
